`ro cache=TRUE, warning=FALSE, comment=NA, message=FALSE, cache.path="bh_lognormal_c01", verbose=TRUE or`
...
noise <- list( det  = c(0,0,0),        low = c(0.1, .1, .1),  gro = c(lvl, 0, 0),
               meas  = c(0, lvl, 0),imp = c(0,0,lvl),gro_meas = c(lvl, lvl, 0), 
