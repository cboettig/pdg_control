...
SDP_Mat1 <- determine_SDP_matrix(f, pars1, x_grid, h_grid, sigma_g, pdfn)
````
...
``` {r  }
SDP_Mat2 <- determine_SDP_matrix(f, pars2, x_grid, h_grid, sigma_g, pdfn)
````
...
``` {r  }
SDP_Mat3 <- determine_SDP_matrix(f, pars3, x_grid, h_grid, sigma_g, pdfn)
````
