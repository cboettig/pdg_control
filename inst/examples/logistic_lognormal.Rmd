`ro cache=TRUE, warning=FALSE, comment=NA, message=FALSE, cache.path="logistic_lognormal/", verbose=TRUE or`
...
scenario <- function(policy_g, policy_m, policy_i){ 
  ...
  SDP_Mat <- SDP_by_simulation(f, pars, x_grid, h_grid, z_g, z_m, z_i, reps=2e5)
