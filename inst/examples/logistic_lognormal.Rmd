`ro cache=TRUE, warning=FALSE, comment=NA, message=FALSE, cache.path="logistic_lognormal_fast/", verbose=TRUE or`
...
ggplot(policy) + 
  geom_point(aes(stock, stock-x_grid[value], color=variable), shape='+') +
	stat_smooth(aes(stock, stock-x_grid[value], color=variable), degree=1, se=FALSE) +
  ylab("escapement") 
