`ro tidy=FALSE, warning=FALSE, comment=NA, message=FALSE, verbose=TRUE, cache=TRUE, cache.path="resilience_assessment/" or`
...
ForwardSimulate <- 
  ...
  for(t in 1:(OptTime-1)){
    ...
    # Track the location of the stable and unstable points?
