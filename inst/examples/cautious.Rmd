...
Bellman's algorithm to compute the a cautious solution that selects a fraction `P` = `r P <- 1` of the optimal harvest solution for all possible trajectories in the iterative optimization.  
