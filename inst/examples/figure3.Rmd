`ro cache=TRUE, warning=FALSE, comment=NA, message=FALSE, cache.path="figure3_det/", verbose=TRUE or`
...
ggplot(linear) + geom_smooth(aes(x,y,color=variable), fill=NA) + xlab("Measured Stock") + ylab("Optimal Expected Escapement")
