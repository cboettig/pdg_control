...
noise <- list(s0=c(0,0,0), sg=c(lvl, 0, 0), sm=c(0, lvl, 0), si=c(0,0,lvl), sgm=c(lvl, lvl, 0), sgi=c(lvl, 0, lvl), smi = c(0, lvl, lvl), sgmi=c(lvl, lvl, lvl)) 
