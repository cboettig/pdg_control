`ro cache=TRUE, tidy=FALSE, warning=FALSE, comment=NA, message=FALSE, fig.width=10, fig.height=10, refresh=8 or`
 ...
 * license: CC0
 ...
 Implements a numerical version of the SDP described in `r knitcitations::citep("10.1016/j.jeem.200.5.11.005")`.
