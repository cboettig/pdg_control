...
opt <- optim_policy(SDP_Mat, x_grid, h_grid, OptTime, xT, profit, delta, reward=0, P=.3)

# Calculate the Reed optimum (e.g. no cost to policy adjustment)
reed <- find_dp_optim(SDP_Mat, x_grid, h_grid, OptTime, xT, profit, delta, scrap_value, interval)
