...
#stats_xcor <- dt[, xcor(fishstock, harvest), by=c("penalty_fn", "reps")]
```
...
cross-correlation of harvests and stock sizes through time. <!-- NOTE Are we showing cross-correlations or not?-->
