...
```{r Figure_1, fig.cap="ICCAT Stock assessments and US Quotas for Bluefin Tuna, 1987 - 2007", fig.width=6, fig.height=4, dev=c("pdf", "svg", "png")}
...
optimal policies. But interestingly, it is the only formulation that
...
_Economic penalties promised for the supplement are still to come_
